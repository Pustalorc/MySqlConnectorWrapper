...
[UsedImplicitly]
public class MySqlConnectorDatabase<T1, T2> : IDisposable where T1 : IConnectorConfiguration where T2 : class
{
    ...
    public MySqlConnectorDatabase(T1 configuration, IEqualityComparer<T2> comparer)
    {
        Comparer = comparer;
        ...
        MySqlTransaction? transaction = null)
    {
        ...
        query.MySqlConnectorCallback?.Invoke(constructedOutput, connection);
